...
if __name__ == '__main__':
    ...
    landmarkDirs = ['annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_train.txt',
                    'annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_test.txt']

    outDirs = ['train_data_98', 'test_data_98']
